...
console.log(("Concured - Express server listening on port " + app.get('port')));
...
db.once('open', function callback () {
  console.log("Concured client-side db started on : "+ config.mongodb_database+ ": "+config.node_web_server_host);
});
